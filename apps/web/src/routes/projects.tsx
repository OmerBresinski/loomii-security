...
export default function ProjectsPage() {
  ...
  const hasActiveFilters = filters.search.length > 0 || filters.riskLevel.length > 0

  return (
    <div className="flex h-full flex-col overflow-hidden p-6">
      {/* Toolbar */}
      <div className="flex items-center gap-3 pb-4">
        <Button asChild size="sm" className="size-8 p-0 bg-[#2C7FFF] hover:bg-[#2C7FFF]/90 text-white">
