...
1. A "## Summary" heading followed by a 2-3 sentence paragraph explaining what the project is and why it exists. Be slightly contextual — not just what it does, but enough context to understand its purpose. Adapt your language to the content: if sources are product requirements, describe it in product terms; if sources are implementation tickets, describe it in technical terms.

2. A "## Involves" heading followed by a single line listing the key areas, systems, or domains the project relates to. This could be technologies (e.g., "pgvector, BullMQ, Bedrock") or product areas (e.g., "user onboarding, billing, permissions") depending on the content.
...
notification infrastructure, user preferences, email/push/in-app delivery
...
Rules:
- Always start with "## Summary" as the first line.
- Always use "## Involves" as the heading before the domains/areas line.
